...
@router.get(
    ...
    **Example:**
    ```
    GET /team-five?division=2030&gender=M&limit=25
    ```
    """
)
...
@router.get(
    ...
    **Example:**
    ```
    GET /team-five/123?season_year=2024&division=2030&gender=M
    ```
    """
)
async def get_team(
...
@router.get(
    ...
    **Example:**
    ```
    GET /team-five/123/resume?season_year=2025&division=2030&gender=M
    ```
    """,
    responses={
